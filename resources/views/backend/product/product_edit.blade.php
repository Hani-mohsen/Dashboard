                        ...
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input  value="{{$details->color}}" name="color" class="form-control visually-hidden" data-role="tagsinput" value="Red,White,Black">
                                </div>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="remark" type="radio" value="FEATURED"
                                           {{ $product->remark == 'FEATURED' ? 'checked' : '' }} id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">FEATURED</label>
                                </div>

                                <div class="form-check">
                                    <input class="form-check-input" name="remark" type="radio" value="NEW"
                                           {{ $product->remark == 'NEW' ? 'checked' : '' }}  id="flexCheckDefault">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="remark" type="radio" value="COLLECTION"
                                           {{ $product->remark == 'COLLECTION' ? 'checked' : '' }}  id="flexCheckDefault">
