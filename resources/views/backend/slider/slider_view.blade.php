            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="font-16 ms-auto">
                        <a href="{{route('add.slider')}}"><i title="add"
                                                               class="fadeIn animated bx bx-message-square-add"
                        ...
                        @foreach ( $slider as $row)
                            <tr>
                                ...
                                <td><a class="editbtn"><i title="edit"
                                    ...
                                    <a href="{{ route('delete.slider',$row->id) }}" id="delete"><i title="delete"
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <form method="post" action="{{route('update.slider')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-1">
                            <img id="showImage" src="{{ url('upload/no-image.jpg') }}"
