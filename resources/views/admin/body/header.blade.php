        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                    ...
                    @endphp
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span class="alert-count">{{count($notifications)}}</span>
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="msg-name"> {{$item->title}}<span class="msg-time float-end">
												{{$item->date}}</span></h6>
                    ...
                    @endphp
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span class="alert-count">{{count($message)}}</span>
                                ...
                                @foreach($message as $item)
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="msg-info">{{ Str::limit($item->message, 25, '..') }}</p>
                                        </div>
                                    </div>
                                </a>
                                @endforeach
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ !empty($adminData->profile_photo_path)?
                                       ...
                                       url('upload/no-image.jpg') }}" class="user-img" alt="user avatar">
